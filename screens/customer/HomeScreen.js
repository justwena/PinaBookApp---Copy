  ...
  return (
    <SafeAreaView style={styles.container}>
                ...
                <View>
                  ...
                  {bookingSearchQuery &&
                    unregisteredBookings.filter(
                      ...
                      <View style={styles.noBookingFoundContainer}>
                        <Text style={styles.noBookingFoundTitle}>
                          No booking found with ID:
                        </Text>
                        <Text style={styles.bookingSearchQuery}>
                          {bookingSearchQuery}
                        </Text>
                      </View>
                    )}
      ...
      {!user && showMessage && (
        ...
        >
          <Text style={styles.messageText}>Search your booking ID here</Text>
        </Animated.View>
      )}
    </SafeAreaView>
  );
